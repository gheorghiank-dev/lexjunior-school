...
/**
 * Past Simple – Interrogative (skeleton page)
 */
  ...
  return (
    <TenseTheoryPageShell>
      <header className="page-header">
        ...
        <h1 className="page-title">Past Simple – Interrogative</h1>
        <p className="page-lead">
          Pagină de teorie pentru Past Simple – Interrogative. Conținutul
      ...
      <TenseTheorySectionCard
        ...
        intro={
          <>
            Aceasta este o pagină-schelet pentru Past Simple – Interrogative.
