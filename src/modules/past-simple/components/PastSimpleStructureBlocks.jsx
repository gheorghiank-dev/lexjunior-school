...
export function PastSimpleNegativeStructureBlock() {
  return (
    <div className="lj-structure-box">
...
export function PastSimpleInterrogativeStructureBlock() {
  return (
    <div className="lj-structure-box">
...
export function PastSimpleUsesStructureBlock() {
  return (
    <div className="lj-structure-box">
      <h3 className="lj-structure-title">Typical uses of Past Simple</h3>
...
export function PastSimpleTimeExpressionsStructureBlock() {
  return (
    <div className="lj-structure-box">
