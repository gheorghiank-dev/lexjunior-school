...
export function PresentPerfectContinuousNegativeStructureBlock() {
  return (
    <div className="lj-structure-box">
...
export function PresentPerfectContinuousInterrogativeStructureBlock() {
  return (
    <div className="lj-structure-box">
...
export function PresentPerfectContinuousUsesStructureBlock() {
  return (
    <div className="lj-structure-box">
      <h3 className="lj-structure-title">Typical uses of Present Perfect Continuous</h3>
...
export function PresentPerfectContinuousTimeExpressionsStructureBlock() {
  return (
    <div className="lj-structure-box">
