...
/**
 * Present Perfect Continuous – Negative (skeleton page)
 */
  ...
  return (
    <TenseTheoryPageShell>
      <header className="page-header">
        ...
        <h1 className="page-title">Present Perfect Continuous – Negative</h1>
        <p className="page-lead">
          Pagină de teorie pentru Present Perfect Continuous – Negative. Conținutul
      ...
      <TenseTheorySectionCard
        ...
        intro={
          <>
            Aceasta este o pagină-schelet pentru Present Perfect Continuous – Negative.
