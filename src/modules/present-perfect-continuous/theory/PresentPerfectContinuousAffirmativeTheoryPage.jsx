...
/**
 * Present Perfect Continuous – Affirmative (skeleton page)
 */
    ...
    <TenseTheoryPageShell>
      <header className="page-header">
        <p className="page-header-kicker">
          <Link
            to={PRESENT_PERFECT_CONTINUOUS_BASE_PATH}
        ...
        <h1 className="page-title">Present Perfect Continuous – Afirmativ</h1>
        <p className="page-lead">
          Reguli, exemple și explicații pentru formarea Present Perfect Continuous la
          afirmativ.
        </p>
      </header>
      ...
      <TenseTheorySectionCard
        ...
        intro={
          <>
            Aceasta este o pagină-schelet pentru Present Perfect Continuous – Affirmative. Aici
      ...
      <TenseTheoryCard>
        ...
        <p className="card-description">
          ...
          exerciții pentru Present Perfect Continuous – Afirmativ, poți merge înapoi la teorie
          sau la hartă.
        </p>
        ...
        <TenseTheoryNextSteps
          actions={[
            ...
            {
              to: presentPerfectContinuousRoomPath(SECTION_ID, 1),
              label: "Începe Camera 1 – Afirmativ",
              variant: "primary",
            },
            {
              to: presentPerfectContinuousMapPath(),
              label: "Mergi la harta Present Perfect Continuous",
              variant: "outline",
            },
            {
              to: presentPerfectContinuousOverviewPath(),
              label: "Vezi recapitularea Present Perfect Continuous",
              variant: "secondary",
            },
          ]}
        />
