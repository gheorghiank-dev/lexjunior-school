...
export default function PsInterrogativeTheoryPage() {
  useEffect(() => {
    markTheoryCompleted(SECTION_ID).catch((err) => {
      console.error("Failed to mark interrogative theory as completed:", err);
    });
  }, []);
    ...
    <TenseInterrogativeTheoryTemplate
      ...
      section1Intro={
        <>
          ...
          la începutul propoziției. După <strong>Do / Does</strong>, verbul
          rămâne întotdeauna în <strong>forma de bază</strong> (fără -s / -es).
        </>
      }
      section1Content={
        <>
      ...
      section2Content={
        <>
          <div className="columns-2">
            <div className="rule-box">
              ...
              <ul className="ps-mini-list">
                ...
                <li>
                  <LexTtsButton text="Do they go to school by bus?" /> Do they
                  go to school by bus?
                </li>
                <li>
                  <LexTtsButton text="Does he play football?" /> Does he play
                ...
                <li>
                  <LexTtsButton text="Does she read books in English?" /> Does
                  she read books in English?
                </li>
                <li>
          ...
          <p style={{ marginTop: "0.75rem" }}>
            <strong>Important:</strong> în răspunsurile scurte folosim
            întotdeauna <em>do / does</em>, nu verbul principal.
          </p>
        </>
      }
      mistakesIntro={
        <>
          ...
          <strong>Do / Does</strong>
          rămâne la forma de bază sau când folosim <strong>Do</strong> în loc de{" "}
          <strong>Does</strong>
