...
export function PresentPerfectNegativeStructureBlock() {
  return (
    <div className="lj-structure-box">
...
export function PresentPerfectInterrogativeStructureBlock() {
  return (
    <div className="lj-structure-box">
...
export function PresentPerfectUsesStructureBlock() {
  return (
    <div className="lj-structure-box">
      <h3 className="lj-structure-title">Typical uses of Present Perfect</h3>
...
export function PresentPerfectTimeExpressionsStructureBlock() {
  return (
    <div className="lj-structure-box">
