...
/**
 * Present Perfect – Interrogative (skeleton page)
 */
  ...
  return (
    <TenseTheoryPageShell>
      <header className="page-header">
        ...
        <h1 className="page-title">Present Perfect – Interrogative</h1>
        <p className="page-lead">
          Pagină de teorie pentru Present Perfect – Interrogative. Conținutul
      ...
      <TenseTheorySectionCard
        ...
        intro={
          <>
            Aceasta este o pagină-schelet pentru Present Perfect – Interrogative.
