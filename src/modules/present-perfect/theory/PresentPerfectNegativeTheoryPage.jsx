...
/**
 * Present Perfect – Negative (skeleton page)
 */
  ...
  return (
    <TenseTheoryPageShell>
      <header className="page-header">
        ...
        <h1 className="page-title">Present Perfect – Negative</h1>
        <p className="page-lead">
          Pagină de teorie pentru Present Perfect – Negative. Conținutul
      ...
      <TenseTheorySectionCard
        ...
        intro={
          <>
            Aceasta este o pagină-schelet pentru Present Perfect – Negative.
