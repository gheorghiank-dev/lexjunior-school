...
/**
 * Future Perfect Continuous – Negative (skeleton page)
 */
  ...
  return (
    <TenseTheoryPageShell>
      <header className="page-header">
        ...
        <h1 className="page-title">Future Perfect Continuous – Negative</h1>
        <p className="page-lead">
          Pagină de teorie pentru Future Perfect Continuous – Negative. Conținutul
      ...
      <TenseTheorySectionCard
        ...
        intro={
          <>
            Aceasta este o pagină-schelet pentru Future Perfect Continuous – Negative.
