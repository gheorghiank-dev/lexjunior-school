...
/**
 * Future Perfect Continuous – Time Expressions (skeleton page)
 */
    ...
    <TenseTheoryPageShell>
      <header className="page-header">
        <p className="page-header-kicker">
          <Link to={futurePerfectContinuousMapPath()} className="page-header-backlink">
            ← Înapoi la harta Future Perfect Continuous
          </Link>
        </p>

        <h1 className="page-title">Future Perfect Continuous – Time Expressions</h1>
        <p className="page-lead">
          Pagină de teorie pentru Future Perfect Continuous – Time Expressions. Conținutul
      ...
      <TenseTheorySectionCard
        ...
        intro={
          <>
            Aceasta este o pagină-schelet pentru Future Perfect Continuous – Time Expressions.
