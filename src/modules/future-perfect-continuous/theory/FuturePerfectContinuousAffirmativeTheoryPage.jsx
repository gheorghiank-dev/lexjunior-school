...
export default function FuturePerfectContinuousAffirmativeTheoryPage() {
  ...
  return (
    <TenseAffirmativeTheoryTemplate
      ...
      section1Intro={<>În această lecție păstrăm aceeași structură vizuală ca la <strong>Present Simple</strong>, dar o adaptăm pentru <strong>Future Perfect Continuous</strong>.</>}
      section1Content={
        <ScaffoldAffirmativeSectionOne
          formula="Subiect + will have been + verb-ing"
          examples={[
      ...
      mistakesIntro={<>Cardul de greșeli frecvente rămâne standard și pentru Future Perfect Continuous.</>}
      mistakes={[
