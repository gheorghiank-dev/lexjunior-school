...
/**
 * Future Perfect Continuous – Affirmative (skeleton page)
 */
    ...
    <TenseTheoryPageShell>
      <header className="page-header">
        <p className="page-header-kicker">
          <Link
            to={FUTURE_PERFECT_CONTINUOUS_BASE_PATH}
            className="btn btn-soft ps-back-link"
          >
            ← Înapoi la harta Future Perfect Continuous
          </Link>
        </p>

        <h1 className="page-title">Future Perfect Continuous – Afirmativ</h1>
        <p className="page-lead">
          Reguli, exemple și explicații pentru formarea Future Perfect Continuous la
          afirmativ.
        </p>
      </header>
      ...
      <TenseTheorySectionCard
        ...
        intro={
          <>
            Aceasta este o pagină-schelet pentru Future Perfect Continuous – Affirmative. Aici
      ...
      >
        <p>
          ...
          Continuous și să adaptezi regulile pentru Future Perfect Continuous.
        </p>
      </TenseTheorySectionCard>
      ...
      <TenseTheoryCard>
        ...
        <p className="card-description">
          ...
          exerciții pentru Future Perfect Continuous – Afirmativ, poți merge înapoi la teorie
          sau la hartă.
        </p>
        ...
        <TenseTheoryNextSteps
          actions={[
            ...
            {
              to: futurePerfectContinuousRoomPath(SECTION_ID, 1),
              label: "Începe Camera 1 – Afirmativ",
              variant: "primary",
            },
            {
              to: futurePerfectContinuousMapPath(),
              label: "Mergi la harta Future Perfect Continuous",
              variant: "outline",
            },
            {
              to: futurePerfectContinuousOverviewPath(),
              label: "Vezi recapitularea Future Perfect Continuous",
              variant: "secondary",
            },
          ]}
        />
