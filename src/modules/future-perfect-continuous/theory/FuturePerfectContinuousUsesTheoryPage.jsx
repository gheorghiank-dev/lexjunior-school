...
/**
 * Future Perfect Continuous – Uses (skeleton page)
 */
  ...
  return (
    <TenseTheoryPageShell>
      <header className="page-header">
        ...
        <h1 className="page-title">Future Perfect Continuous – Uses</h1>
        <p className="page-lead">
          Pagină de teorie pentru Future Perfect Continuous – Uses. Conținutul
      ...
      <TenseTheorySectionCard
        ...
        intro={
          <>
            Aceasta este o pagină-schelet pentru Future Perfect Continuous – Uses.
