// Future Perfect Continuous > Time Expressions content registry (playable preview scaffold)
...
export const FUTURE_PERFECT_CONTINUOUS_TIME_EXPRESSIONS_EXERCISES_BY_ROOM = createPreviewExercisesByRoom({
  prefix: "future-perfect-continuous-time-expressions",
...
const FUTURE_PERFECT_CONTINUOUS_TIME_EXPRESSIONS_GLOSSARY_BY_ROOM = createPreviewGlossaryByRoom({
  tenseLabel: "Future Perfect Continuous",
  sectionLabel: FUTURE_PERFECT_CONTINUOUS_TIME_EXPRESSIONS_SECTION_LABEL,
});
...
export const FUTURE_PERFECT_CONTINUOUS_TIME_EXPRESSIONS_ROOMS = Array.from(
  ...
  (_, idx) => {
    ...
    return {
      ...
      sectionLabel: FUTURE_PERFECT_CONTINUOUS_TIME_EXPRESSIONS_SECTION_LABEL,
      roomNumber,
      exercises: FUTURE_PERFECT_CONTINUOUS_TIME_EXPRESSIONS_EXERCISES_BY_ROOM[roomNumber] ?? [],
    };
  },
);
