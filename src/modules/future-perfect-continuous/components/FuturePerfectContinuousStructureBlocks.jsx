...
export function FuturePerfectContinuousNegativeStructureBlock() {
  return (
    <div className="lj-structure-box">
...
export function FuturePerfectContinuousInterrogativeStructureBlock() {
  return (
    <div className="lj-structure-box">
...
export function FuturePerfectContinuousUsesStructureBlock() {
  return (
    <div className="lj-structure-box">
      <h3 className="lj-structure-title">Typical uses of Future Perfect Continuous</h3>
...
export function FuturePerfectContinuousTimeExpressionsStructureBlock() {
  return (
    <div className="lj-structure-box">
