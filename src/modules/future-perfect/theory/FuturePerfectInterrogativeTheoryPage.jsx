...
/**
 * Future Perfect – Interrogative (skeleton page)
 */
  ...
  return (
    <TenseTheoryPageShell>
      <header className="page-header">
        ...
        <h1 className="page-title">Future Perfect – Interrogative</h1>
        <p className="page-lead">
          Pagină de teorie pentru Future Perfect – Interrogative. Conținutul
      ...
      <TenseTheorySectionCard
        ...
        intro={
          <>
            Aceasta este o pagină-schelet pentru Future Perfect – Interrogative.
