// Future Perfect > Interrogative content registry (skeleton)
import { FUTURE_PERFECT_ROOMS_PER_SECTION, FUTURE_PERFECT_SECTIONS } from "../future-core/config.js";

export const FUTURE_PERFECT_INTERROGATIVE_EXERCISES_BY_ROOM = {};
...
const FUTURE_PERFECT_INTERROGATIVE_GLOSSARY_BY_ROOM = {};
...
export const FUTURE_PERFECT_INTERROGATIVE_ROOMS = Array.from(
  ...
  (_, idx) => {
    ...
    return {
      ...
      roomNumber,
      exercises:
        FUTURE_PERFECT_INTERROGATIVE_EXERCISES_BY_ROOM[roomNumber] ?? [],
    };
  },
);
