// Future Perfect > Uses content registry (playable preview scaffold)
...
export const FUTURE_PERFECT_USES_EXERCISES_BY_ROOM = createPreviewExercisesByRoom({
  prefix: "future-perfect-uses",
...
const FUTURE_PERFECT_USES_GLOSSARY_BY_ROOM = createPreviewGlossaryByRoom({
  tenseLabel: "Future Perfect",
  sectionLabel: FUTURE_PERFECT_USES_SECTION_LABEL,
});
...
export const FUTURE_PERFECT_USES_ROOMS = Array.from(
  ...
  (_, idx) => {
    ...
    return {
      ...
      sectionLabel: FUTURE_PERFECT_USES_SECTION_LABEL,
      roomNumber,
      exercises: FUTURE_PERFECT_USES_EXERCISES_BY_ROOM[roomNumber] ?? [],
    };
  },
);
