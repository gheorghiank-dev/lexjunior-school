// Future Perfect > Affirmative content registry (playable preview scaffold)
...
export const FUTURE_PERFECT_AFFIRMATIVE_EXERCISES_BY_ROOM = createPreviewExercisesByRoom({
  prefix: "future-perfect-affirmative",
...
const FUTURE_PERFECT_AFFIRMATIVE_GLOSSARY_BY_ROOM = createPreviewGlossaryByRoom({
  tenseLabel: "Future Perfect",
  sectionLabel: FUTURE_PERFECT_AFFIRMATIVE_SECTION_LABEL,
});
...
export const FUTURE_PERFECT_AFFIRMATIVE_ROOMS = Array.from(
  ...
  (_, idx) => {
    ...
    return {
      ...
      sectionLabel: FUTURE_PERFECT_AFFIRMATIVE_SECTION_LABEL,
      roomNumber,
      exercises: FUTURE_PERFECT_AFFIRMATIVE_EXERCISES_BY_ROOM[roomNumber] ?? [],
    };
  },
);
