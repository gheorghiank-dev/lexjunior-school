...
export const PAST_PERFECT_USES_ROOMS = Array.from(
  ...
  (_, idx) => {
    ...
    return {
      ...
      roomNumber,
      exercises:
        PAST_PERFECT_USES_EXERCISES_BY_ROOM[roomNumber] ?? [],
    };
  },
);
