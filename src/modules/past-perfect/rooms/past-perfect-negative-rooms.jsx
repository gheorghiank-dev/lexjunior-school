...
export const PAST_PERFECT_NEGATIVE_ROOMS = Array.from(
  ...
  (_, idx) => {
    ...
    return {
      ...
      roomNumber,
      exercises:
        PAST_PERFECT_NEGATIVE_EXERCISES_BY_ROOM[roomNumber] ?? [],
    };
  },
);
