...
/**
 * Past Perfect – Time Expressions (skeleton page)
 */
  ...
  return (
    <TenseTheoryPageShell>
      <header className="page-header">
        ...
        <h1 className="page-title">Past Perfect – Time Expressions</h1>
        <p className="page-lead">
          Pagină de teorie pentru Past Perfect – Time Expressions. Conținutul
      ...
      <TenseTheorySectionCard
        ...
        intro={
          <>
            Aceasta este o pagină-schelet pentru Past Perfect – Time Expressions.
