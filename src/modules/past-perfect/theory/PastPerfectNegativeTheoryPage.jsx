...
/**
 * Past Perfect – Negative (skeleton page)
 */
  ...
  return (
    <TenseTheoryPageShell>
      <header className="page-header">
        ...
        <h1 className="page-title">Past Perfect – Negative</h1>
        <p className="page-lead">
          Pagină de teorie pentru Past Perfect – Negative. Conținutul
      ...
      <TenseTheorySectionCard
        ...
        intro={
          <>
            Aceasta este o pagină-schelet pentru Past Perfect – Negative.
