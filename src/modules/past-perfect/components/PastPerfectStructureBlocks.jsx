...
export function PastPerfectNegativeStructureBlock() {
  return (
    <div className="lj-structure-box">
...
export function PastPerfectInterrogativeStructureBlock() {
  return (
    <div className="lj-structure-box">
...
export function PastPerfectUsesStructureBlock() {
  return (
    <div className="lj-structure-box">
      <h3 className="lj-structure-title">Typical uses of Past Perfect</h3>
...
export function PastPerfectTimeExpressionsStructureBlock() {
  return (
    <div className="lj-structure-box">
