...
/**
 * Past Perfect Continuous – Uses (skeleton page)
 */
  ...
  return (
    <TenseTheoryPageShell>
      <header className="page-header">
        ...
        <h1 className="page-title">Past Perfect Continuous – Uses</h1>
        <p className="page-lead">
          Pagină de teorie pentru Past Perfect Continuous – Uses. Conținutul
      ...
      <TenseTheorySectionCard
        ...
        intro={
          <>
            Aceasta este o pagină-schelet pentru Past Perfect Continuous – Uses.
