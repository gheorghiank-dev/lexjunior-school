// Past Perfect Continuous > Uses content registry (skeleton)
...
export const PAST_PERFECT_CONTINUOUS_USES_EXERCISES_BY_ROOM = {};
...
const PAST_PERFECT_CONTINUOUS_USES_GLOSSARY_BY_ROOM = {};
...
export const PAST_PERFECT_CONTINUOUS_USES_ROOMS = Array.from(
  ...
  (_, idx) => {
    ...
    return {
      ...
      roomNumber,
      exercises:
        PAST_PERFECT_CONTINUOUS_USES_EXERCISES_BY_ROOM[roomNumber] ?? [],
    };
  },
);
