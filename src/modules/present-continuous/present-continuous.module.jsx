...
const routes = [
  ...
  // Interrogative
  { path: pcTheoryPath("interrogative"), element: <PcInterrogativeTheoryPage /> },
  { path: pcRoomPath("interrogative", 1), element: <PcInterrogativeRoom1Page /> },
  { path: pcRoomPath("interrogative", 2), element: <PcInterrogativeRoom2Page /> },
  { path: pcRoomPath("interrogative", 3), element: <PcInterrogativeRoom3Page /> },
  { path: pcRoomPath("interrogative", 4), element: <PcInterrogativeRoom4Page /> },
  { path: pcRoomPath("interrogative", 5), element: <PcInterrogativeRoom5Page /> },
  { path: pcRoomPath("interrogative", 6), element: <PcInterrogativeRoom6Page /> },
  { path: pcRoomPath("interrogative", 7), element: <PcInterrogativeRoom7Page /> },
  ...
  // Time Expressions
  { path: pcTheoryPath("time-expressions"), element: <PcTimeExpressionsTheoryPage /> },
  { path: pcRoomPath("time-expressions", 1), element: <PcTimeExpressionsRoom1Page /> },
  { path: pcRoomPath("time-expressions", 2), element: <PcTimeExpressionsRoom2Page /> },
  { path: pcRoomPath("time-expressions", 3), element: <PcTimeExpressionsRoom3Page /> },
  { path: pcRoomPath("time-expressions", 4), element: <PcTimeExpressionsRoom4Page /> },
  { path: pcRoomPath("time-expressions", 5), element: <PcTimeExpressionsRoom5Page /> },
  { path: pcRoomPath("time-expressions", 6), element: <PcTimeExpressionsRoom6Page /> },
  { path: pcRoomPath("time-expressions", 7), element: <PcTimeExpressionsRoom7Page /> },
