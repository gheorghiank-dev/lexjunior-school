...
export default function PcUsesRoom3Page() {
  ...
  const {
    ...
    startKeyAttempt,
    handlePracticeReset,
  } = useRoomEngine({ sectionId: "uses", roomNumber: 3, exercises });
  ...
  return (
    <TenseRoomPageShell
      ...
      retryForKeyTestId="pc-uses-room3-retry-for-key"
    >
      <section className="card">
        <h2 className="card-title">Uses – camera 3</h2>
        ...
        <TextInputExerciseList
          ...
          testIdPrefix="pc-uses-room3"
        />

        <TenseExerciseActions
          onVerify={handleVerify}
          passed={roomState.passed}
          verifyTestId="pc-uses-room3-verify"
        />
      </section>
    </TenseRoomPageShell>
  );
