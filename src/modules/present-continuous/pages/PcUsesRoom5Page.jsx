...
export default function PcUsesRoom5Page() {
  ...
  const {
    ...
    startKeyAttempt,
    handlePracticeReset,
  } = useRoomEngine({ sectionId: "uses", roomNumber: 5, exercises });
  ...
  return (
    <TenseRoomPageShell
      ...
      retryForKeyTestId="pc-uses-room5-retry-for-key"
    >
      <section className="card">
        <h2 className="card-title">Uses – camera 5</h2>
        ...
        <TextInputExerciseList
          ...
          testIdPrefix="pc-uses-room5"
        />

        <TenseExerciseActions
          onVerify={handleVerify}
          passed={roomState.passed}
          verifyTestId="pc-uses-room5-verify"
        />
      </section>
    </TenseRoomPageShell>
  );
