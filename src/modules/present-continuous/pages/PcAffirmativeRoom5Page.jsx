...
export default function PcAffirmativeRoom5Page() {
  const pageTitle = "Present Continuous – Camera 5";
  const exercises = useMemo(
    () => [
      {
        id: "pc-affirmative-room5-ex1",
  ...
  const {
    ...
    startKeyAttempt,
    handlePracticeReset,
  } = useRoomEngine({ sectionId: "affirmative", roomNumber: 5, exercises });
  ...
  return (
    <TenseRoomPageShell
      ...
      retryForKeyTestId="pc-affirmative-room5-retry-for-key"
    >
      <section className="card">
        <h2 className="card-title">Camera 5 – schelet</h2>
        ...
        <TextInputExerciseList
          ...
          testIdPrefix="pc-affirmative-room5"
        />

        <TenseExerciseActions
          onVerify={handleVerify}
          passed={roomState.passed}
          verifyTestId="pc-affirmative-room5-verify"
        />
      </section>
    </TenseRoomPageShell>
  );
