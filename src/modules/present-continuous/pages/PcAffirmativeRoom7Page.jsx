...
export default function PcAffirmativeRoom7Page() {
  const pageTitle = "Present Continuous – Camera 7";
  const exercises = useMemo(
    () => [
      {
        id: "pc-affirmative-room7-ex1",
  ...
  const {
    ...
    startKeyAttempt,
    handlePracticeReset,
  } = useRoomEngine({ sectionId: "affirmative", roomNumber: 7, exercises });
  ...
  return (
    <TenseRoomPageShell
      ...
      retryForKeyTestId="pc-affirmative-room7-retry-for-key"
    >
      <section className="card">
        <h2 className="card-title">Camera 7 – schelet</h2>
        ...
        <TextInputExerciseList
          ...
          testIdPrefix="pc-affirmative-room7"
        />

        <TenseExerciseActions
          onVerify={handleVerify}
          passed={roomState.passed}
          verifyTestId="pc-affirmative-room7-verify"
        />
      </section>
    </TenseRoomPageShell>
  );
