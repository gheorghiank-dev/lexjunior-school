...
export default function PcTimeExpressionsRoom6Page() {
  ...
  const {
    ...
    startKeyAttempt,
    handlePracticeReset,
  } = useRoomEngine({ sectionId: "time-expressions", roomNumber: 6, exercises });
  ...
  return (
    <TenseRoomPageShell
      ...
      retryForKeyTestId="pc-time-expressions-room6-retry-for-key"
    >
      <section className="card">
        <h2 className="card-title">Time expressions – camera 6</h2>
        ...
        <TextInputExerciseList
          ...
          testIdPrefix="pc-time-expressions-room6"
        />

        <TenseExerciseActions
          onVerify={handleVerify}
          passed={roomState.passed}
          verifyTestId="pc-time-expressions-room6-verify"
        />
      </section>
    </TenseRoomPageShell>
  );
