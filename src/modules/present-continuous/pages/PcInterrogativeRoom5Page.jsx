...
export default function PcInterrogativeRoom5Page() {
  ...
  } = useRoomEngine({ sectionId: "interrogative", roomNumber: 5, exercises });

  const pageTitle = "Camera 5 – Present Continuous Interrogative";
  ...
  return (
    <TenseRoomPageShell
      ...
      retryForKeyTestId="pc-retry-for-key-interrogative-5"
    >
      <section className="card">
        ...
        <TextInputExerciseList
          ...
          testIdPrefix="pc-interrogative-room5"
        />

        <TenseExerciseActions
          onVerify={handleVerify}
          passed={roomState.passed}
          verifyTestId="pc-interrogative-room5-verify"
        />
      </section>
    </TenseRoomPageShell>
  );
