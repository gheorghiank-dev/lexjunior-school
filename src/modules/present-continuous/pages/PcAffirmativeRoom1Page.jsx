...
export default function PcAffirmativeRoom1Page() {
  ...
  const {
    ...
    startKeyAttempt,
    handlePracticeReset,
  } = useRoomEngine({ sectionId: "affirmative", roomNumber: 1, exercises });

  const pageTitle = "Camera 1 – Present Continuous – Affirmative";
    ...
    >
      <section className="card">
        ...
        <TextInputExerciseList
          ...
          testIdPrefix="pc-affirmative-room1"
        />

        <TenseExerciseActions
          onVerify={handleVerify}
          passed={roomState.passed}
          verifyTestId="pc-affirmative-room1-verify"
        />
      </section>
    </TenseRoomPageShell>
  );
