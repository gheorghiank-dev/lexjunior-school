...
export default function PcInterrogativeRoom7Page() {
  ...
  } = useRoomEngine({ sectionId: "interrogative", roomNumber: 7, exercises });

  const pageTitle = "Camera 7 – Present Continuous Interrogative";
  ...
  return (
    <TenseRoomPageShell
      ...
      retryForKeyTestId="pc-retry-for-key-interrogative-7"
    >
      <section className="card">
        ...
        <TextInputExerciseList
          ...
          testIdPrefix="pc-interrogative-room7"
        />

        <TenseExerciseActions
          onVerify={handleVerify}
          passed={roomState.passed}
          verifyTestId="pc-interrogative-room7-verify"
        />
      </section>
    </TenseRoomPageShell>
  );
