...
export default function PcNegativeRoom4Page() {
  ...
  } = useRoomEngine({ sectionId: "negative", roomNumber: 4, exercises });

  const pageTitle = "Camera 4 – Present Continuous Negative";
  ...
  return (
    <TenseRoomPageShell
      ...
      retryForKeyTestId="pc-retry-for-key-negative-4"
    >
      <section className="card">
        ...
        <TextInputExerciseList
          ...
          testIdPrefix="pc-negative-room4"
        />

        <TenseExerciseActions
          onVerify={handleVerify}
          passed={roomState.passed}
          verifyTestId="pc-negative-room4-verify"
        />
      </section>
    </TenseRoomPageShell>
  );
