...
export default function PcInterrogativeRoom3Page() {
  ...
  } = useRoomEngine({ sectionId: "interrogative", roomNumber: 3, exercises });

  const pageTitle = "Camera 3 – Present Continuous Interrogative";
  ...
  return (
    <TenseRoomPageShell
      ...
      retryForKeyTestId="pc-retry-for-key-interrogative-3"
    >
      <section className="card">
        ...
        <TextInputExerciseList
          ...
          testIdPrefix="pc-interrogative-room3"
        />

        <TenseExerciseActions
          onVerify={handleVerify}
          passed={roomState.passed}
          verifyTestId="pc-interrogative-room3-verify"
        />
      </section>
    </TenseRoomPageShell>
  );
