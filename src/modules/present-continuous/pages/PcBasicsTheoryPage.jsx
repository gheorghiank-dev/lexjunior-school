...
export default function PcBasicsTheoryPage() {
  useEffect(() => {
    // gating: mark theory done as soon as the student visits the page
    markTheoryCompleted("basics");
  }, []);
    ...
    <main className="page page-pastel">
      <header className="page-header">
        <div className="page-header-main">
          <h1 className="page-title">Present Continuous – Basics (Teorie)</h1>
        </div>
      </header>
      ...
      <div style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
        <Link className="btn btn-soft" to="/grammar/tenses/present-continuous/map">
          Mergi la hartă
        </Link>
        <Link className="btn btn-outline" to="/grammar/tenses/present-continuous">
