...
export default function PcUsesTheoryPage() {
  useEffect(() => {
    markTheoryCompleted(SECTION_ID).catch((err) => {
      console.error(
        "Failed to mark Present Continuous uses theory as completed:",
        err,
      );
    });
  }, []);
  ...
  return (
    <TenseUsesTheoryTemplate
      ...
      card1Intro={
        <>
          Mai întâi, reține ideea generală: Present Continuous vorbește despre
          ceea ce se întâmplă <strong>acum</strong> sau în jurul momentului
          vorbirii.
        </>
      }
      card1Content={<PcUsesStructureBlock />}
      card2Intro={<>Iată întrebuințările de bază ale acestui timp.</>}
      card2Content={
          ...
          <div className="columns-2">
            <div>
              ...
              <ul className="ps-mini-list">
                <li>
                  acțiuni în desfășurare în momentul vorbirii:{" "}
                  <strong>I am doing the washing up now.</strong>
                </li>
                <li>
                  acțiuni temporare, în desfășurare în jurul momentului
                  vorbirii:{" "}
                  <strong>
                    I am doing a course in programming this month.
                  </strong>
                </li>
                <li>
                  cu <strong>always, constantly, frequently</strong> pentru a
                  exprima enervarea:{" "}
                  <strong>
                    You are constantly arriving late for our meetings.
                  </strong>
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="ps-mini-list">
                <li>
                  aranjamente fixe în viitor:{" "}
                  <strong>
                    Mary and I are flying to Madrid on business next week.
                  </strong>
                </li>
                <li>
                  situații în schimbare sau dezvoltare:{" "}
                  <strong>
                    The climate is getting warmer and warmer every year.
                  </strong>
                </li>
              </ul>
            </div>
      ...
      card3Intro={
        <>
          Ai grijă la nuanță: aici nu vorbim despre rutină, ci despre
          desfășurare, temporar sau schimbare.
        </>
      }
      card3Content={
        <div className="lj-structure-box ps-structure-box">
          ...
          <ul className="ps-mini-list">
            <li>
              Pentru obiceiuri și rutină folosim, de obicei,{" "}
              <strong>Present Simple</strong>.
            </li>
            <li>
              Pentru planuri deja aranjate în viitor putem folosi{" "}
              <strong>Present Continuous</strong>.
            </li>
            <li>
              Cu <strong>always / constantly / frequently</strong>, Present
              Continuous exprimă adesea iritare sau plângere.
            </li>
          </ul>
        </div>
      }
