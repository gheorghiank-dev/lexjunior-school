// Past Continuous > Interrogative content registry (skeleton)
import { PAST_CONTINUOUS_ROOMS_PER_SECTION, PAST_CONTINUOUS_SECTIONS } from "../past-continuous-core/config.js";

export const PAST_CONTINUOUS_INTERROGATIVE_EXERCISES_BY_ROOM = {};
...
const PAST_CONTINUOUS_INTERROGATIVE_GLOSSARY_BY_ROOM = {};
...
export const PAST_CONTINUOUS_INTERROGATIVE_ROOMS = Array.from(
  ...
  (_, idx) => {
    ...
    return {
      ...
      roomNumber,
      exercises:
        PAST_CONTINUOUS_INTERROGATIVE_EXERCISES_BY_ROOM[roomNumber] ?? [],
    };
  },
);
