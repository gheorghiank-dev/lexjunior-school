...
/**
 * Past Continuous – Negative (skeleton page)
 */
  ...
  return (
    <TenseTheoryPageShell>
      <header className="page-header">
        ...
        <h1 className="page-title">Past Continuous – Negative</h1>
        <p className="page-lead">
          Pagină de teorie pentru Past Continuous – Negative. Conținutul
      ...
      <TenseTheorySectionCard
        ...
        intro={
          <>
            Aceasta este o pagină-schelet pentru Past Continuous – Negative.
