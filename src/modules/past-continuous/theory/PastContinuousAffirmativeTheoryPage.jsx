...
/**
 * Past Continuous – Affirmative (skeleton page)
 */
  ...
  return (
    <TenseTheoryPageShell>
      <header className="page-header">
        ...
        <h1 className="page-title">Past Continuous – Afirmativ</h1>
        <p className="page-lead">
          Reguli, exemple și explicații pentru formarea Past Continuous la
          afirmativ.
        </p>
      </header>
      ...
      <TenseTheorySectionCard
        ...
        intro={
          <>
            Aceasta este o pagină-schelet pentru Past Continuous – Affirmative. Aici
      ...
      <TenseTheoryCard>
        ...
        <p className="card-description">
          ...
          exerciții pentru Past Continuous – Afirmativ, poți merge înapoi la teorie
          sau la hartă.
        </p>
        ...
        <TenseTheoryNextSteps
          actions={[
            ...
            {
              to: pastContinuousRoomPath(SECTION_ID, 1),
              label: "Începe Camera 1 – Afirmativ",
              variant: "primary",
            },
            {
              to: pastContinuousMapPath(),
              label: "Mergi la harta Past Continuous",
              variant: "outline",
            },
            {
              to: pastContinuousOverviewPath(),
              label: "Vezi recapitularea Past Continuous",
              variant: "secondary",
            },
          ]}
        />
