...
/**
 * Past Continuous – Uses (skeleton page)
 */
  ...
  return (
    <TenseTheoryPageShell>
      <header className="page-header">
        ...
        <h1 className="page-title">Past Continuous – Uses</h1>
        <p className="page-lead">
          Pagină de teorie pentru Past Continuous – Uses. Conținutul
      ...
      <TenseTheorySectionCard
        ...
        intro={
          <>
            Aceasta este o pagină-schelet pentru Past Continuous – Uses.
