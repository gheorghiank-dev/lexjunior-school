...
export default function PastContinuousTimeExpressionsTheoryPage() {
  ...
  return (
    <TenseTimeExpressionsTheoryTemplate
      ...
      card3Content={<div className="rule-box"><h3>Pattern notes</h3><ul className="ps-mini-list"><li><strong>while / as</strong> introduc frecvent acțiunea mai lungă, în desfășurare.</li><li><strong>when</strong> introduce des acțiunea scurtă care întrerupe.</li><li><strong>This time yesterday</strong> este un semnal clasic pentru Past Continuous.</li></ul></div>}
