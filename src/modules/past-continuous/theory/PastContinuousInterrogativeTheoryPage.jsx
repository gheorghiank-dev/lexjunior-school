...
/**
 * Past Continuous – Interrogative (skeleton page)
 */
  ...
  return (
    <TenseTheoryPageShell>
      <header className="page-header">
        ...
        <h1 className="page-title">Past Continuous – Interrogative</h1>
        <p className="page-lead">
          Pagină de teorie pentru Past Continuous – Interrogative. Conținutul
      ...
      <TenseTheorySectionCard
        ...
        intro={
          <>
            Aceasta este o pagină-schelet pentru Past Continuous – Interrogative.
