...
/**
 * Future Simple – Interrogative (skeleton page)
 */
  ...
  return (
    <TenseTheoryPageShell>
      <header className="page-header">
        ...
        <h1 className="page-title">Future Simple – Interrogative</h1>
        <p className="page-lead">
          Pagină de teorie pentru Future Simple – Interrogative. Conținutul
      ...
      <TenseTheorySectionCard
        ...
        intro={
          <>
            Aceasta este o pagină-schelet pentru Future Simple – Interrogative.
