...
/**
 * Future Simple – Negative (skeleton page)
 */
  ...
  return (
    <TenseTheoryPageShell>
      <header className="page-header">
        ...
        <h1 className="page-title">Future Simple – Negative</h1>
        <p className="page-lead">
          Pagină de teorie pentru Future Simple – Negative. Conținutul
      ...
      <TenseTheorySectionCard
        ...
        intro={
          <>
            Aceasta este o pagină-schelet pentru Future Simple – Negative.
