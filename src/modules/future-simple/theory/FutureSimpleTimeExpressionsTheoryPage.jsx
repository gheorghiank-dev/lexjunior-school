...
/**
 * Future Simple – Time Expressions (skeleton page)
 */
  ...
  return (
    <TenseTheoryPageShell>
      <header className="page-header">
        ...
        <h1 className="page-title">Future Simple – Time Expressions</h1>
        <p className="page-lead">
          Pagină de teorie pentru Future Simple – Time Expressions. Conținutul
      ...
      <TenseTheorySectionCard
        ...
        intro={
          <>
            Aceasta este o pagină-schelet pentru Future Simple – Time Expressions.
